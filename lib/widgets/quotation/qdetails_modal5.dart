...
class QDetailsModal5 extends ConsumerStatefulWidget {
  const QDetailsModal5({super.key, required this.loginResponse});

  final dynamic loginResponse;

  @override
  ConsumerState<QDetailsModal5> createState() => _QDetailsModal5State();
}

class _QDetailsModal5State extends ConsumerState<QDetailsModal5> {
  @override
  void initState() {
    super.initState();
    getQCover();
